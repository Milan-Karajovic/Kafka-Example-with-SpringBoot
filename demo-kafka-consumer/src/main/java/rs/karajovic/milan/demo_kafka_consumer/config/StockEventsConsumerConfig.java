package rs.karajovic.milan.demo_kafka_consumer.config;

import rs.karajovic.milan.demo_kafka_consumer.service.FailureService;
...
public class StockEventsConsumerConfig {
    ...
    @Value("${topics.retry:stock-events.RETRY}")
    private String retryTopic;

    @Value("${topics.dlt:stock-events.DLT}")
